...
const createRawCapture = (captureRepositoryImpl, eventRepositoryImpl) => (async (inputRawCapture) => {
...
const getRawCaptures = (captureRepositoryImpl) => (async (filterCriteria = undefined) => {
    let filter = {};
